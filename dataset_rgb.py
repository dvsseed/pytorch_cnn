...
# valid_dataset = ImageFolder(text=root + 'many_valid250.txt', transform=doTransform)  # test: 250
...
# test_dataset = ImageFolder(text=root + 'many_train1000.txt', transform=doTransform)  # test: 1024
test_dataset = ImageFolder(text=root + 'many_train1.txt', transform=doTransform)  # test: 1
...
train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=False, num_workers=workers, pin_memory=True)
...
test_loader = DataLoader(dataset=test_dataset, batch_size=1, shuffle=False, num_workers=workers, pin_memory=True)
